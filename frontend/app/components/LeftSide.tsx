...
export default function LeftSide({ setShelfName }: {setShelfName: Dispatch<SetStateAction<string>>}) {
  return (
    <div className="flex flex-col items-center mt-16">
      ...
      >
        <Image width={30} height={30} className="flex items-center justify-center h-[30px] w-[30px]" src="/compsciwhite.png" alt="Computer Science" />
      ...
      >
        <Image width={30} height={30} className="flex items-center justify-center h-[30px] w-[30px]" src="/englishwhite.png" alt="English" />
      ...
      >
        <Image width={30} height={30} className="flex items-center justify-center h-[30px] w-[30px]" src="/physicswhite.png" alt="Physics" />
      ...
      >
        <Image width={30} height={30} className="flex items-center justify-center h-[30px] w-[30px]" src="/biologywhite.png" alt="Biology" />
      ...
      >
        <Image width={30} height={30} className="flex items-center justify-center h-[30px] w-[30px]" src="/yourbookswhite.png" alt="Your Books" />
